...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = Bat_Discharge_EN_Pin|DEBUG_EN_Pin;
  ...
  GPIO_InitStruct.Pin = MC20_EN_Pin|LED_Y_Pin|Bat_Charge_En_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = BAT_Charge_Status_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BAT_Charge_Status_GPIO_Port, &GPIO_InitStruct);
